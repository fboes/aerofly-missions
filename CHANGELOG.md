...
- Added fuel / payload properties to SimBrief API fetcher and `main.mcf` export
- Added fuel / payload to `tmc` export

## [2.30.0] - 2026-02-27

- Changed testing to standard Node.js testing suite
- Added properties and basic workflows to add liveries / paint schemes to flight plans
- Added basic parser to get airline codes from SimBrief and convert this into Aerofly liveries
- Improved `main.mcf` flight plan snippet export
