...
import { AircraftFinder } from "./Aircraft.js";
...
export class Mission {
    ...
    set aircraft_livery(aircraft_livery) {
     ...
     */
    set aircraft_livery_icao(icao_airline) {
    ...
    fromMainMcf(mainMcf, ils = 0, withoutCheckpoints = false) {
        ...
        if (distanceOriginAircraft > 2) {
            ...
            if (checkpointDepartureRunway) {
                ...
                this.warnings.push(`Setting position of aircraft to departure runway: ${this.origin_lon_lat}`);
