    ...
    convertToAircraft(aircraft) {
        ...
        const callsign = aircraft.icaoCode
            ? "N" +
                ...
                AircraftFinder.randomizedLetter(aircraft.icaoCode.charCodeAt(0)), AircraftFinder.randomizedLetter((_a = aircraft.icaoCode.charCodeAt(Math.min(aircraft.icaoCode.length - 1, 3))) !== null && _a !== void 0 ? _a : 0), AircraftFinder.randomizedLetter((_b = aircraft.icaoCode.charCodeAt(Math.min(aircraft.icaoCode.length - 1, 2))) !== null && _b !== void 0 ? _b : 0))
            : "N0XXX";
