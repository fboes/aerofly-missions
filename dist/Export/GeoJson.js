...
export class GeoJson {
    ...
    fromMainMcf(mainMcf) {
        ...
        this.features = [
            ...
            ...mainMcf.navigation.Route.Ways.map((waypoint, index) => {
    ...
    fromMission(mission, forExport = false) {
        this.features = [
            ...
            ...mission.checkpoints.map((c, index) => {
                return {
                    type: "Feature",
                    id: index + 1,
                    geometry: {
    ...
    getTurnDegreesForCheckpoint(checkpoint, nextCheckpoint) {
    ...
    isHardTurnCheckpoint(checkpoint, nextCheckpoint, turnRadius) {
